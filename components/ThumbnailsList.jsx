                ...
                <div className={`l-container-thumb ${pokemon.types[0].type.name}`}>
                    ...
                    <div className="h-pd1">
                        <Stack direction="row" spacing={2}>
                            ...
                            { isLoadingRename? 
                                <Button variant="contained" variant="contained" color="primary" endIcon={<HourglassFullIcon />}>
                                    Rename
                                </Button> 
                            : <Button variant="contained" variant="contained" color="primary" endIcon={<DriveFileRenameOutlineIcon />} onClick={() => renamePokemon(pokemon)}>
                                    Rename
                                </Button>
                            }
                        </Stack>
